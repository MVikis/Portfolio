...
export default function CvPage(props){
    ...
    return(
        <div id="cv" >
            ...
            <p className="cv-text">Jag heter Martin Viksten och är en nyexaminerad C#.NET-utvecklare med en bred kompetens inom en rad olika områden. Jag är en driven och resultatinriktad person som ständigt arbetar aktivt med att utvecklas inom programmering. Den här hemsidan är ett exempel på det! <br/>
